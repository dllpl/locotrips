...
@if(is_default_lang())
    ...
    <div class="row" data-condition="sms_driver:is(smsimple)">
        <div class="col-sm-4">
            <h3 class="form-group-title">Настройки Smsimple</h3>
        </div>
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    <div data-condition="sms_driver:is(smsimple)">
                        <div class="form-group">
                            <label class="">Smsimple логин</label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="sms_smsimple_account_sid" value="{{setting_item('sms_smsimple_account_sid',config('sms.smsimple.sid'))}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="">Smsimple пароль</label>
                            <div class="form-controls">
                                <input type="text" class="form-control" name="sms_smsimple_account_token" value="{{setting_item('sms_smsimple_account_token',config('sms.smsimple.token'))}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="">Номер (from)</label>
                            <div class="form-controls">
                                <input type="number" class="form-control" name="sms_smsimple_api_from" value="{{setting_item('sms_smsimple_api_from',config('sms.smsimple.from'))}}">
                            </div>
                        </div>
                    </div>
                </div>

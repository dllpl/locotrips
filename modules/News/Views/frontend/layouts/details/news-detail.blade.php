<div class="article">
    ...
    <div class="space-between">
        ...
        <div class="share"> {{__("Share")}}
            <a class="facebook share-item" href="https://vk.com/share.php?url={{$row->getDetailUrl()}}&amp;title={{$translation->title}}" target="_blank" original-title="VK"><i class="fa fa-vk fa-lg"></i></a>
            <a class="twitter share-item" href="whatsapp://send?text={{$row->getDetailUrl()}}&amp;title={{$translation->title}}" target="_blank" original-title="Whatsapp"><i class="fa fa-whatsapp fa-lg"></i></a>
        </div>
    </div>
</div>
    ...
    <div class="container-fluid">
        ...
        <div class="text-right">
            <div class="header-status-control">
                ...
                <a class="btn btn-primary" href="{{ route('hotel.admin.index',['status'=>'pending'])  }}">Проверка</a> -
                <a class="btn btn-primary" href="{{ route('hotel.admin.index',['status'=>'draft'])  }}">Черновик</a>
            </div>

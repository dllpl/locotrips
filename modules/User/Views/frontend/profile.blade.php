    ...
    <form action="{{route('user.profile.update')}}" method="post" class="input-has-icon">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                @endif
                <div class="form-group" style="visibility: hidden;width:0px;height:0px;">
                    <label>{{__("User name")}}</label>
                    <input type="text" name="user_name" value="uid{{old('user_name',$dataUser->id)}}" placeholder="{{__("User name")}}" class="form-control">
                </div>
            ...
            <div class="col-md-6" style="visible:hidden;width:0; height:0;">
                <div class="form-title">

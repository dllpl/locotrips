...
<div class="form-group">
	<div class="row ">
		...
		;?>
		<label class="col-md-3 col-form-label">{{$fieldName}}
		...
		<div class="col-md-{{$value_col_size ?? 4}}">
			@if(empty($only_show_data))
				<input type="text" class="form-control mb-1" id="phone_verify_field" name="verify_data_{{$field['id']}}" placeholder="+7(___)___-__-__" value="{{$field['data']}}">

...
@section('content')
    <div class="container-fluid">
        <div class="dashboard-page">
            <h4 class="welcome-title text-uppercase">Показатели системы</h4>
        </div>
        <br>
        <div class="row">
            @if(!empty($top_cards))
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="dashboard-report-card card info">
                            <div class="card-content">
                                ...
                                <span class="card-amount">@php $token = 'YbUz0Z3mQnwMDd055a356297b3008a5cde8d204b079e6';
                                                                $ch = curl_init();
                                ...
                                <span class="card-desc">Статус шлюза</span>
                            </div>
                            <div class="card-media">
            ...
            <div class="col-md-12 col-lg-6 mb-3" style="padding-left:0px!important;padding-right:0px!important;">
                <div class="panel">
